...
const Services=()=>{
    return(
        ...
        icon={<BsShieldFillCheck font={21} className="text-white"/>}
    ...
    <ServiceCard
        ...
        icon={<BiSearchAlt font={21} className="text-white"/>}
        subtitle="Security is guaranted we always maintain privacy and maintain the quality of our product."
        />

        <ServiceCard
        color="bg-[#f84550]"
        title="Fastest transation"
        icon={<RiHeart2Fill font={21} className="text-white"/>}
        subtitle="Security is guaranted we always maintain privacy and maintain the quality of our product."
        />
        </div>
        </div>
